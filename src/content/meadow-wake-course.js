...
export const MEADOW_WAKE_BLOCK_DEFINITIONS = Object.freeze([
  ...
  block('coin-opening-crown', 'coin', 9.5, 2.28, { reward: 5 }),
  block('coin-log-arc', 'coin', 14.25, 1.65, { reward: 5 }),
  block('breakable-log-landing-a', 'standard-breakable', 20.8, 1.45),
  block('breakable-log-landing-b', 'standard-breakable', 21.55, 1.45),
  block('coin-log-landing', 'coin', 22.3, 1.45, { reward: 5 }),
  block('hidden-log-lookout', 'coin', 23.05, 2.35, { reward: 10, hidden: true }),
  ...
  block('breakable-ruin-exit-a', 'standard-breakable', 35.75, 1.5),
  block('breakable-ruin-exit-b', 'standard-breakable', 36.5, 1.5),
  block('coin-ruin-exit', 'coin', 37.25, 1.5, { reward: 5 }),
