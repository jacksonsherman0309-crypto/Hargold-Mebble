...
- The July 27, 2026 user-supplied Meshy appearances and their matching 24-bone rigs are explicitly approved and locked for live gameplay animation. Per the July 30, 2026 correction, the supplied Meshy animation clips are not locked and are retained only as reference/debug sources. Project-authored walk, run, sprint, and action clips may replace them provided they animate only the locked skeleton from its own bind transforms; rejected procedural actions may not be retargeted.
