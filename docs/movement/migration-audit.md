...
`src/gameplay/movement/unified-character-controller.js` is the only active hero locomotion and physics authority. `src/game.js` samples browser/mobile input, advances the 120 Hz loop, supplies world collision queries, and consumes movement output.
