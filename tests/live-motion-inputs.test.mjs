...
assert.match(gameSource, /handleMovementEvents\(player\.events\)/);
assert.match(gameSource, /createGroundSlamImpactPresentation/);
assert.match(gameSource, /resolveGroundSlamMobImpacts/);
assert.match(gameSource, /triggerGroundSlamImpact/);
